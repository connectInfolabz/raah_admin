...
function ViewMediaImages() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/getMedia`);
    ...
    const handleDelete = async (mediaId) => {
        try {
            await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/deleteMedia`, {
                mediaId,
            });
                                    ...
                                    <div key={media._id}>
                                        ...
                                        >
                                            <img
                                                ...
                                                src={`${process.env.REACT_APP_MONGO_BASE_URL}/images/mediaPics/${media.mediaImage}`}
