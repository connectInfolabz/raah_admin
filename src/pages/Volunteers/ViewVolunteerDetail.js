...
function ViewVolunteerDetail() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/getVolunteerDetailById`, {
                    reqId: reqId,
                })
    ...
    const approveRequest = async (status) => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/approveVolunteerRequest`, {
                reqId,
                status
            });
                                    ...
                                    <div className="col-lg-4">
                                        <div className="card mb-4 shadow">
                                            <div className="card-body text-center">
                                                <img
                                                    src={`${process.env.REACT_APP_MONGO_BASE_URL}/images/profilePics/${volunteer.profilePic}`}
                                                    alt="avatar"
