...
function AddVolunteer() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/getVolunteerRequest`);
    ...
    },
    {
        ...
        selector: (row) => (
            ...
            >
                <img
                    src={`${process.env.REACT_APP_MONGO_BASE_URL}/images/profilePics/${row.profilePic}`}
                    alt={row.profilePic}
