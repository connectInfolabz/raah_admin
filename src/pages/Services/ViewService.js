...
function ViewService() {
    ...
    const fetchService = async () => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/getService`);
    ...
    const handleDelete = async (serviceId) => {
        try {
            await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/deleteService`, {
                serviceId,
            });
                                    ...
                                    <div key={service._id}>
                                        ...
                                        >
                                            <img
                                                ...
                                                src={`${process.env.REACT_APP_MONGO_BASE_URL}/images/servicePics/${service.servicePic}`}
