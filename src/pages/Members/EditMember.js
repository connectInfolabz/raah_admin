...
function EditMember() {
    ...
    const [data, setData] = useState({
        memberId: location.state._id,
        memberName: location.state.memberName,
        memberRole: location.state.memberRole,
        memberPic: "",
    });
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/editMember`, formData);
                    ...
                    <div className="container-fluid">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title fw-semibold mb-4">Edit Member</h5>
