...
function ViewMember() {
    ...
    const fetchMembers = async () => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/getMembers`);
    ...
    const handleDelete = async (memberId) => {
        try {
            await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/deleteMember`, {
                memberId,
            });
                                    ...
                                    <div key={member._id}>
                                        ...
                                        >
                                            <img
                                                ...
                                                src={`${process.env.REACT_APP_MONGO_BASE_URL}/images/memberPics/${member.memberPic}`}
