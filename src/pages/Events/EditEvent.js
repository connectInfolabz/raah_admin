...
function EditEvent() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/editEvent`, formData);
                    ...
                    <div className="container-fluid">
                        <div className="card overflow-hidden shadow">
                            <div className="card-body">
                                <h5 className="card-title fw-semibold mb-4">Edit Event</h5>
