...
function ViewEvents() {
  ...
  const fetchEvents = async () => {
    try {
      const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/getEvents`);
                  ...
                  <div key={event._id}>
                    ...
                    >
                      <img
                        ...
                        src={`${process.env.REACT_APP_MONGO_BASE_URL}/images/eventPics/${event.eventPic}`}
                        alt={event.eventName}
                      />
